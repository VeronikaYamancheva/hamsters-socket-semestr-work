...
public class PlayerDisconnectedListener extends AbstractEventListener
{
    @Override
    public void handle(Message message, int connectionId, int clientsCount) throws EventListenerException {
        ...
        buffer.put(data);
        server.sendBroadCastMessage( MessageCreator.createMessage(MessageType.PLAYER_DISCONNECTED, buffer.array()));
    }
